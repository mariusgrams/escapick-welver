const games=[
  {
    ...
    description:"Der Medizinstudent Holger, machte während seines Studiums, mehrere Auslandssemester in Afrika und Asien. Hierbei entdeckte er den Impfstoff, gegen Covid-19. Diesen brachte er eines Tages mit nach Deutschland und deponierte ihn in seinem Studentenzimmer. Während einer Vorlesung verschafft ihr Euch zutritt, zu seinem Zimmer und sucht nach dem Impfstoff. Doch, denkt dran, die Vorlesung geht nur 60 Minuten.",
  ...
  },
  {
    ...
    duration: '60 Minuten und mehr... <br> <br> Bestzeit: 65:57 Minuten am 03.04.2026',
    playTime: '60 Minuten und mehr',
  ...
  {
    id:"4",
    title:"Die Mystery-Box mit dem ? (NEU)",
    titleImage:"img/Mystery-Box/title.jpg",
    description:"Willkommen. Vor Euch steht ein Objekt, das eigentlich nicht existieren dürfte. Eine Kiste aus tiefschwarzem Holz, versiegelt, ohne Scharniere und ohne Schlösser. Die weißen Fragezeichen an den Seiten sind nicht nur Dekoration - sie sind eine Provokation. Was befindet sich im Inneren dieser Kiste, der keinen Eingang hat? Setzt Euch und nehmt Platz. Ihr habt nur Euren Verstand, um das Unmögliche möglich zu machen. Die Frage ist nicht nur, was in der Kiste ist, sondern ob ihr schlau genug seid, sie zur Preisgabe ihres Geheimnisses zu zwingen. Die Zeit läuft.",
    ...
    availableSince: '01. April 2026',
    duration: '75 Minuten und mehr ......',
    playTime: '75 Minuten und mehr ......',
    playerSize: '2 Personen',
    playable: 'Zur Zeit nur vor Ort',
    specialFeatures: 'Wieder eine Rätselkiste, die man sich nach Hause holen kann.',
    ideaOrigin: 'Die erste Rätselkiste kam ganz gut an und da ich damals die Holzkiste im 2er Pack gekauft habe, musste ich noch eine weitere bauen.',
    additionalImages: [],
    priceLine1: '',
    priceLine2: 'Rätselkiste für 30 € (auch für zu Hause, aber eigener Transport)'
  },
